...
/* ═══════════════════════════════════════════
   0. DONNÉES — 49 interventions, 21-25 Avril 2026
   Source: sfax_nettoyage_dashboard_v2_1
═══════════════════════════════════════════ */
const DATA = [
  {date:'2026-04-21',mun:'العامرة',ton:170,mk:0,type:'كنس يدوي / رفع فضالت مختلفة / رفع فضالت منزلية / رفع مصبات عشوائية',places:'الطريق الرئيسي المهدية / المنطقة الصناعية السعادي / العامرة / حومة الجامع العامرة / عمادة السلام',workers:'12 عامل',equip:'معدات خفيفة / 03 شاحنة / bobcat / جرار / تراكس'},
  {date:'2026-04-21',mun:'الشيحية',ton:84,mk:0,type:'معالجة نقاط سوداء / كنس الأتربة / إزالة الأعشاب / رفع فضلات منزلية',places:'شارع محمد علي / شارع الحبيب ثامر / شارع المنارة / شارع البيئة / شارع الإمام سحنون',workers:'أعوان بلدية الشيحية',equip:'شاحنة ثقيلة'},
  {date:'2026-04-21',mun:'النصر',ton:9,mk:0,type:'رفع فضلات منزلية / رفع نقاط سوداء',places:'منطقة الغرابة عمادة النصر / سيدي محمد بن عمر',workers:'فريق النظافة',equip:'جرار / شاحنة'},
  {date:'2026-04-21',mun:'جبنيانة',ton:45,mk:0,type:'رفع الفواضل المختلفة / كنس ورفع الأتربة / تقليع الأعشاب / رفع فواضل الزبيرة',places:'شارع البيئة',workers:'أعوان البلدية',equip:'—'},
  ...
  {date:'2026-04-21',mun:'عقارب',ton:64,mk:0,type:'تنظيف وكنس / إزالة أتربة / جمع المواد البلاستيكية / رفع مصب عشوائي',places:'المنتزه البلدي / بطحاء الجربان / حي المنتزه / طريق المحروقة / حي بن ابراهيم',workers:'05 عملة البلدية / 10 عملة من مصلحة الغابات',equip:'جرار 4 طن / شاحنة 7 طن / آلة جارفة'},
  {date:'2026-04-21',mun:'منزل شاكر',ton:25,mk:0,type:'مواصلة برنامج السقي / رفع الفضلات المنزلية / تنظيف محيط المستشفى',places:'محيط المستشفى المحلي / عمادة منزل شاكر / عمادة بوثدي',workers:'6 عملة / سائق',equip:'آلة شحن صغيرة / جرار / شاحنة ضاغطة'},
  {date:'2026-04-21',mun:'قرمدة',ton:107,mk:0,type:'معالجة نقاط سوداء / كنس الأتربة / إزالة الأعشاب / رفع فضلات منزلية',places:'شارع بوزيان / طريق قرمدة / شارع محمود مقديش / شارع الشهداء',workers:'أعوان البلدية',equip:'—'},
  {date:'2026-04-21',mun:'طينة',ton:72,mk:1000,type:'كنس حواشي الأرصفة / تقليع الأعشاب / رفع النقاط السوداء',places:'قصاص التوتة / المكتبة العمومية بطينة / تنظيف وادي الحكموني',workers:'أعوان البلدية / إدارة المياه العمرانية',equip:'02 تراكتوبال / 02 شاحنة قالبة / معدات يدوية'},

  {date:'2026-04-22',mun:'المحرس',ton:66,mk:3000,type:'إزالة الأعشاب / تجميع النفايات البلاستيكية / رفع فضلات الزبيرة / الكنس / السقي',places:'الفسحة الشاطئية الكورنيش / المنطقة البلدية / نهج الأغالبة',workers:'أعوان البلدية / أهالي المنطقة',equip:'—'},
  {date:'2026-04-22',mun:'ساقية الزيت',ton:110,mk:1300,type:'كنس الأتربة / رفع فضلات مختلفة / رفع فضلات منزلية / ازالة الأعشاب',places:'شارع الحبيب بورقيبة / شارع محمد الخامس / المستودع البلدي بالأنس / دار الشباب سيدي صالح',workers:'معدات خفيفة / 03 شاحنة / bobcat / جرار',equip:'معدات خفيفة / 03 شاحنة / bobcat / جرار'},
  {date:'2026-04-22',mun:'العامرة',ton:110,mk:0,type:'كنس يدوي / رفع فضلات مختلفة / رفع فضلات منزلية / العناية بالحدائق',places:'الطريق الرئيسي المهدية / حومة الجامع العامرة / جوار مغازة عزيزة',workers:'12 عامل',equip:'معدات خفيفة / 03 شاحنة / bobcat'},
  {date:'2026-04-22',mun:'العين',ton:100,mk:0,type:'رفع المصبات العشوائية / تعهد الطرقات / كنس الطرقات / رفع الفضلات / إزالة الأعشاب',places:'زنقة الشيخ / طريق العين / نهج العباسية / نهج الشيخ اللخمي',workers:'أعوان البلدية / مقاول كنس',equip:'—'},
  {date:'2026-04-22',mun:'النصر',ton:2.5,mk:0,type:'رفع فضلات منزلية',places:'منطقة الغرابة عمادة النصر / سيدي محمد بن عمر',workers:'فريق النظافة',equip:'جرار / شاحنة'},
  {date:'2026-04-22',mun:'بئر علي بن خليفة',ton:160,mk:0,type:'رفع فضلات منزلية / رفع فضلات البناء و الأجنة',places:'حي المستقبل / السوق الاسبوعية وسط المدينة',workers:'أعوان البلدية',equip:'جرار ومجرورة / شاحنة / تراكس / آلة جارفة'},
  {date:'2026-04-22',mun:'جبنيانة',ton:55,mk:1600,type:'رفع الفواضل المختلفة / كنس ورفع الأتربة / تقليع الأعشاب / رفع فواضل الزبيرة',places:'نهج علي الزواوي / شارع البيئة',workers:'أعوان البلدية',equip:'—'},
  {date:'2026-04-22',mun:'عقارب',ton:21,mk:0,type:'تنظيف وكنس / إزالة أتربة / رفع مصب هامشي',places:'المنتزه البلدي / حي العكاشات / السوق الاسبوعية / سوق الخضر / شارع البيئة',workers:'05 عملة البلدية / 08 عملة من مقاولات الكنس',equip:'جرار 4 طن / شاحنة 7 طن / آلة جارفة'},
  {date:'2026-04-22',mun:'قرمدة',ton:125,mk:0,type:'معالجة نقاط سوداء / كنس الأتربة / إزالة الأعشاب / رفع فضلات منزلية',places:'نهج القيروان / شارع فلسطين / مدخل مقبرتي الرشاد / شارع الشهداء',workers:'أعوان البلدية',equip:'—'},
  {date:'2026-04-22',mun:'طينة',ton:101,mk:1000,type:'كنس حواشي الأرصفة / تقليع الأعشاب / رفع النقاط السوداء',places:'حي الهواء / جنان القطي / مسلك عميرة / قصاص التوتة / واد الحكموني',workers:'أعوان البلدية / إدارة المياه العمرانية',equip:'02 تراكتوبال / 03 شاحنة قالبة / معدات يدوية'},

  {date:'2026-04-23',mun:'صفاقس',ton:204,mk:1300,type:'معالجة نقاط سوداء / كنس الأتربة / إزالة الأعشاب',places:'طريق العين / سيدي منصور',workers:'51 أعوان البلدية / مقاولات المذيوب',equip:'—'},
  {date:'2026-04-23',mun:'الصخيرة',ton:7,mk:0,type:'تنظيف حواشي الطرقات / رفع فضلات مختلفة',places:'منطقة صبيح',workers:'عملة البلدية / عملة الحظائر الظرفية / مقاول',equip:'02 شاحنة قالبة / تراكتوبال / آلة ماسحة'},
  {date:'2026-04-23',mun:'ساقية الزيت',ton:110,mk:1000,type:'كنس حواشي الأرصفة / تقليع الأعشاب / رفع الأتربة / رفع فضلات مختلفة',places:'تقسيم الأنس / الطريق المحاذي للسكة الحديدية / نهج خير الدين باشا',workers:'—',equip:'—'},
  {date:'2026-04-23',mun:'العامرة',ton:138,mk:0,type:'كنس يدوي / حملة نظافة شاملة / رفع نقاط سوداء / رفع فضلات منزلية',places:'الطريق الرئيسي المهدية / عمادة أولاد حسن / عمادة ذراع بن زياد',workers:'أنوان البلدية',equip:'معدات خفيفة / 03 شاحنة / bobcat / جرار'},
  {date:'2026-04-23',mun:'الشيحية',ton:32,mk:0,type:'كنس الأتربة وإزالة الأعشاب / رفع فضلات منزلية',places:'شارع البيئة / الطريق الرئيسي',workers:'02 شاحنة',equip:'02 شاحنة'},
  {date:'2026-04-23',mun:'الغريبة',ton:15,mk:0,type:'حملة نظافة',places:'مقر قصر البلدية',workers:'03 عملة',equip:'—'},
  {date:'2026-04-23',mun:'النصر',ton:2.5,mk:0,type:'جمع ورفع فضلات منزلية',places:'منطقة الغرابة / حي دخان / الأغوام / الطهاهرة',workers:'فريق النظافة',equip:'جرار / شاحنة'},
  {date:'2026-04-23',mun:'بئر علي بن خليفة',ton:180,mk:0,type:'رفع فضلات منزلية / رفع فضلات البناء',places:'وسط المدينة / حي النجاح / المعهد الثانوي بئر علي',workers:'عملة البلدية / مقاول التنظيف',equip:'جرار ومجرورة / شاحنة / تراكس / BOBCAT'},
  {date:'2026-04-23',mun:'جبنيانة',ton:45,mk:600,type:'رفع الفواضل المختلفة / كنس ورفع الأتربة / تقليع الأعشاب',places:'نهج سيدي أبي إسحاق / ساحة مقر سيدي أبي إسحاق / شارع الحبيب بورقيبة',workers:'أعوان البلدية',equip:'—'},
  {date:'2026-04-23',mun:'قرمدة',ton:105,mk:0,type:'معالجة نقاط سوداء / كنس الأتربة / إزالة الأعشاب / رفع فضلات منزلية',places:'نهج طارق ابن زياد / شارع الحبيب ثامر / تقسيم بن جماعة / مقبرة سيدي الطيبي',workers:'أعوان البلدية',equip:'—'},
  {date:'2026-04-23',mun:'ساقية الدائر',ton:115,mk:0,type:'رفع المصبات العشوائية / رفع النقاط السوداء / جهر الاتربة / كنس يدوي / تشذيب أشجار النخيل',places:'مدخل المسلخ البلدي / شارع فرحات حشاد / نهج ابن شرف / نهج 9 أفريل',workers:'أعوان البلدية',equip:'—'},
  {date:'2026-04-23',mun:'طينة',ton:76,mk:1000,type:'كنس حواشي الأرصفة / تقليع الأعشاب / رفع نقاط سوداء',places:'حي المعز / قصاص التوتة / حي بنسعيدة / طريق سيدي عبيد',workers:'أعوان البلدية',equip:'02 تراكتوبال / 03 شاحنة قالبة / معدات يدوية'},

  {date:'2026-04-24',mun:'صفاقس',ton:107,mk:600,type:'معالجة نقاط سوداء / كنس الأتربة / إزالة الأعشاب',places:'طريق العين / وادي الشعبوني / قصاص شعبان / طريق تونس',workers:'42 عون بلدي / مقاولة التنظيف',equip:'—'},
  {date:'2026-04-24',mun:'المحرس',ton:358,mk:0,type:'إزالة النقاط السوداء / فضلات منزلية / إزالة مصب عشوائي / رفع فضلات البناء',places:'السوق الأسبوعية / المنطقة البلدية / حي المعاصر / حي الهناء / شاطئ الشفار',workers:'بلدية المحرس عن طريق المقاولات / وزارة البيئة',equip:'—'},
  {date:'2026-04-24',mun:'العامرة',ton:110,mk:0,type:'كنس يدوي / رفع نقاط سوداء / رفع فضلات منزلية / إزالة الأعشاب',places:'الطريق الرئيسي المهدية / منطقة العوابد / طريق انشلة',workers:'—',equip:'02 شاحنة / جرار ومجرورة / Bobcat / تراكس'},
  {date:'2026-04-24',mun:'الشيحية',ton:29,mk:0,type:'معالجة النقاط السوداء / كنس الأتربة / إزالة الأعشاب / رفع الفضلات المنزلية',places:'شارع الحبيب ثامر / شارع افريقيا / شارع قرطاج / شارع البيئة',workers:'أعوان البلدية',equip:'—'},
  {date:'2026-04-24',mun:'العين',ton:250,mk:0,type:'رفع المصبات العشوائية / تعهد الطرقات / كنس الطرقات / رفع الفضلات / تشذيب الأشجار / إزالة الأعشاب',places:'طريق منزل شاكر / نهج تمغزة / شارع البيئة / القاصة رقم 4',workers:'أعوان البلدية / مقاولة كنس',equip:'—'},
  {date:'2026-04-24',mun:'النصر',ton:2,mk:0,type:'رفع فضلات منزلية',places:'منطقة الغرابة / الصغايرة / القصادلة / حي الجواودة',workers:'أعوان البلدية',equip:'جرار / شاحنة'},
  {date:'2026-04-24',mun:'بئر علي بن خليفة',ton:190,mk:0,type:'رفع فضلات منزلية / رفع فضلات البناء والحدائق',places:'وسط المدينة / حي النصر 1 / الحديقة / حي الفتح / الطريق الوطنية',workers:'أعوان البلدية / مقاولة تنظيف',equip:'جرار ومجرورة / شاحنة / تراكس / BOBCAT'},
  {date:'2026-04-24',mun:'جبنيانة',ton:112,mk:750,type:'رفع الفواضل المختلفة / كنس ورفع الأتربة / تقليع الأعشاب',places:'طريق أولاد حسن / شارع البيئة / نهج الإمام سحنون',workers:'أعوان البلدية',equip:'—'},
  {date:'2026-04-24',mun:'عقارب',ton:72,mk:1400,type:'حملة نظافة / كنس وتنظيف سوق الخضر / رفع فضلات بلاستيكية / ازالة الأعشاب',places:'الطريق الرابطة بين الشعاشعة والأفرار / بطحاء الجربان / سوق الخضر',workers:'05 عملة بلدية عقارب / 10 عاملات من مصلحة الغابات',equip:'شاحنة 4 طن / جرار / مكنسة آلية / bobcat'},
  {date:'2026-04-24',mun:'قرمدة',ton:105,mk:0,type:'معالجة نقاط سوداء / كنس الأتربة / إزالة الأعشاب',places:'شارع الطبلبي / شارع محمد الجمل / شارع محمود كريشان',workers:'أعوان النظافة / مقاولة التنظيف',equip:'—'},
  {date:'2026-04-24',mun:'ساقية الدائر',ton:95,mk:0,type:'رفع المصبات العشوائية / رفع النقاط السوداء / جهر الاتربة / كنس يدوي / تشذيب أشجار النخيل',places:'نهج الطاهر صفر / نهج البساتين / نهج الشهداء / وسط الساقية',workers:'أعوان البلدية',equip:'—'},
  {date:'2026-04-24',mun:'طينة',ton:78,mk:1200,type:'كنس حواشي الأرصفة / تقليع الأعشاب / رفع نقاط سوداء',places:'طريق المحارزة / حي العقاربة / طريق سيدي عبيد / مدخل حي طينة',workers:'أعوان البلدية',equip:'02 شاحنة قالبة / 02 آلة تراكتوبال / معدات يدوية'},

  {date:'2026-04-25',mun:'العامرة',ton:78,mk:0,type:'كنس يدوي / رفع فضلات منزلية',places:'الطريق الرئيسي المهدية / عمادة السلام / منطقة العقاربة من عمادة السعادي',workers:'أعوان البلدية',equip:'02 شاحنات / جرار ومجرورة / Bobcat / تراكس'},
  {date:'2026-04-25',mun:'النصر',ton:2,mk:0,type:'رفع فضلات منزلية',places:'منطقة الغرابة / الغيب والنيب / حي بئر الشعبة',workers:'أعوان البلدية',equip:'جرار / شاحنة'},
  {date:'2026-04-25',mun:'جبنيانة',ton:65,mk:650,type:'رفع الفواضل المختلفة / كنس ورفع الأتربة / تقليع الأعشاب',places:'شارع الحبيب بورقيبة / حديقة سيدي أبي إسحاق',workers:'أعوان البلدية',equip:'—'},
...
// Source: جدول_اجمالي.xlsx — 98 بلاغ
// ═══════════════════════════════════════════
const REPORTS_DATA = [
  {
    "id": "r001",
  ...
  if (!_allReports.length) {
    btnWrap.innerHTML = muns.map((m, i) => {
      ...
      <button class="mun-report-stat-btn" style="--mc:${c1}" onclick="openMunReportsPopup(${JSON.stringify(m)})">
        ...
        <div class="mrb-pills">
          <span class="mrb-pill mrb-pill-p mrb-pill-0">⏳ 0</span>
          <span class="mrb-pill mrb-pill-i mrb-pill-0">🔧 0</span>
          <span class="mrb-pill mrb-pill-r mrb-pill-0">✅ 0</span>
        </div>
      </button>`;
    }).join('');
    return;
...
async function submitReport() {
  ...
  const payload = {
    ...
    municipality: document.getElementById('f_mun')?.value,
    phone:        document.getElementById('f_phone')?.value?.trim() || null,
    location:     document.getElementById('f_location')?.value?.trim(),
    severity:     document.getElementById('f_severity')?.value || 'متوسطة',
    description:  document.getElementById('f_desc')?.value?.trim(),
    lat:          window._geoLat  || null,
    lng:          window._geoLng  || null,
  };
  ...
  document.getElementById('formWrap').style.display = 'none';
  document.getElementById('successWrap').style.display = 'block';
  showToast('✅ تم تسجيل البلاغ محلياً');
